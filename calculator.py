    ...
    if not car_date or not car_price or not car_engine_displacement:
        ...
        keyboard.add(
            types.InlineKeyboardButton(
                "Написать менеджеру Артёму", url="https://t.me/swallows_from_korea"
            )
        )
        keyboard.add(
            types.InlineKeyboardButton(
    ...
    if call.data.startswith("detail"):
        ...
        if current_country == "Russia":
            ...
            detail_message = (
                ...
                f"<b>ПРИМЕЧАНИЕ: ЦЕНА НА АВТОМОБИЛЬ ЗАВИСИТ ОТ ТЕКУЩЕГО КУРСА, ДЛЯ БОЛЕЕ ТОЧНОЙ ИНФОРМАЦИИ НАПИШИТЕ НАШЕМУ МЕНЕДЖЕРУ @swallows_from_korea</b>"
            )
        ...
        if current_country == "Kyrgyzstan":
            ...
            detail_message = (
                ...
                f"<b>ПРИМЕЧАНИЕ: ЦЕНА НА АВТОМОБИЛЬ ЗАВИСИТ ОТ ТЕКУЩЕГО КУРСА, ДЛЯ БОЛЕЕ ТОЧНОЙ ИНФОРМАЦИИ НАПИШИТЕ НАШЕМУ МЕНЕДЖЕРУ @swallows_from_korea (Артём)</b>"
            )
        ...
        keyboard.add(
            types.InlineKeyboardButton(
                "Связаться с менеджером Артёмом", url="https://t.me/swallows_from_korea"
            )
        )
        keyboard.add(
            types.InlineKeyboardButton(
...
def calculate_cost_manual(country, year, month, engine_volume, price, car_type):
    ...
    if country == "Russia":
        ...
        result_message = (
            ...
            f"Цены могут варьироваться в зависимости от курса, для более подробной информации пишите @swallows_from_korea"
        )
